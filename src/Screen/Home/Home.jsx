...
import video from "../../assets/video.mp4"; // make sure vedio.mp4 is inside src/assets
    ...
    <div className="relative min-h-screen bg-black text-white flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto mb-12">
          We specialize in creating innovative technology solutions that drive business
          growth. From custom software development to AI integration, we help companies
        ...
        <div className="flex gap-6 justify-center mt-10">
          <button
            ...
            style={{
              ...
              boxShadow: '0 10px 30px rgba(0,0,0,0.3), inset 0 1px 1px rgba(255,255,255,0.1), inset 0 -1px 1px rgba(0,0,0,0.3)',
          ...
          >
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ background: 'radial-gradient(circle at 50% 0%, rgba(255,255,255,0.2) 0%, transparent 50%)' }} />
        ...
        <div className="relative w-full overflow-hidden mt-20">
          ...
          >
            {brands.concat(brands).map((brand, index) => (
              <div key={index} className="flex items-center opacity-70 hover:opacity-100 transition">
                {brand.icon}
                <span className={`text-xl font-semibold tracking-wide ${brand.underline ? "border-b-2 pb-1" : ""}`}>
                  {brand.name}
                </span>
              </div>
            ))}
